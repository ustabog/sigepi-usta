    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_inst', models.IntegerField(choices=[('CC', 'Cédula'), ('TI', 'Tarjeta de identidad'), ('CE', 'Cédula de Extranjería'), ('PA', 'Pasaporte'), ('PR', 'Permiso de Residencia')], default=0, verbose_name='Tipo de institución o entidad')),
