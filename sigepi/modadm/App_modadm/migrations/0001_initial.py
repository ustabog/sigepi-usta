    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.IntegerField(choices=[(0, 'Sistema'), (1, 'Admin Módulo Administración'), (2, 'Admin App Usuarios'), (3, 'Admin App Grupos'), (4, 'Admin App Instituciones'), (5, 'Admin Aplicaciones'), (6, 'Admin Extensión'), (7, 'Invitado')], default=0)),
                ('id_app', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='App_modadm.app_mod')),
                ('id_ext_app', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='App_modadm.ext_app')),
                ('id_ext_mod', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='App_modadm.ext_mod')),
