    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_nuip', models.CharField(choices=[('Cédula', 'Cédula'), ('Tarjeta de identidad', 'Tarjeta de identidad'), ('Cédula de Extranjería', 'Cédula de Extranjería'), ('Pasaporte', 'Pasaporte'), ('Permiso de Residencia', 'Permiso de Residencia')], default=0, max_length=30)),
                ...
                ('gene', models.CharField(choices=[('Neutro', 'Neutro'), ('Femenino', 'Femenino'), ('Masculino', 'Masculino'), ('Intergénero', 'Intergénero'), ('Transgénero', 'Transgénero'), ('Sisgénero', 'Sisgénero'), ('Otro', 'Otro')], default=0, max_length=30, verbose_name='Género')),
                ('ocup', models.CharField(max_length=30, verbose_name='Ocupacion ')),
                ('dir', models.CharField(max_length=100, verbose_name='Direccion ')),
                ('id_usu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
