...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'plantillas',
            BASE_DIR / 'plantillas/iu_pub',
            BASE_DIR / 'plantillas/iu_pub/apps_iu',
            BASE_DIR / 'plantillas/iu_pub/comp_iu',
            BASE_DIR / 'plantillas/iu_pub/portada_iu',
            BASE_DIR / 'plantillas/admsgp',
            BASE_DIR / 'plantillas/admsgp/apps_adm',
            BASE_DIR / 'plantillas/admsgp/comps_adm',
            BASE_DIR / 'plantillas/admsgp/portada_adm',
            BASE_DIR / 'plantillas/consultas',
            BASE_DIR / 'plantillas/consultas/apps_cons',
            BASE_DIR / 'plantillas/consultas/comps_cons',
            BASE_DIR / 'plantillas/consultas/portada_cons',
            BASE_DIR / 'plantillas/api',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
