...
class prod_inv(models.Model): #preguntar nombre de la tabla ojo tipo_pro_inv
    ...
    id_usu = models.ForeignKey(User, on_delete=models.CASCADE, null=False, blank =False) #Identificador único del usuario que realizó el producto
...
class usu_inf_inv(models.Model):
    ...
    id_usu = models.ForeignKey(User, on_delete=models.CASCADE, null=False, blank =False)  # Identificador único de usuario # identificador unico
