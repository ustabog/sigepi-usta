...
#------------------------------ CRONOGRAMA ---------------------
class vts_crea_crono(CreateView):
    ...
    success_url= reverse_lazy('crono_pry')
...
class vts_ls_etapa(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(vts_ls_etapa, self).get_context_data(**kwargs)
        context ['titulo_pagina'] = 'Etapas'
        return context

#------------------------------ FASE ---------------------
class vts_crea_fase(CreateView):
...
class vts_ls_fase(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(vts_ls_fase, self).get_context_data(**kwargs)
        context ['titulo_pagina'] = 'Fases'
        return context
#------------------------------ PROCESO ---------------------
class vts_crea_proc(CreateView):
...
class vts_ls_proc(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(vts_ls_proc, self).get_context_data(**kwargs)
        context ['titulo_pagina'] = 'Procesos'
        return context
#------------------------------ TAREA ---------------------
class vts_crea_tarea(CreateView):
...
class vts_ls_tarea(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(vts_ls_tarea, self).get_context_data(**kwargs)
        context ['titulo_pagina'] = 'Tareas'
        return context

#------------------------------ ACTIVIDAD ---------------------
class vts_crea_acti(CreateView):
...
class vts_ls_acti(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(vts_ls_acti, self).get_context_data(**kwargs)
