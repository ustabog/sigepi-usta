...
class crono_pry (models.Model):
    ...
    id_pry = models.ForeignKey(pry_base, null=False, blank =False)#Proyecto base
    resp_pry = models.ForeignKey(usu, on_delete=models.CASCADE, null= False, blank = False)# responsable del proyecto
    ...
    acti = models.ForeignKey(acti, null=False, blank =False)
    tarea = models.ForeignKey(tarea, null=False, blank =False)
...
class acti(models.Model):
    ...
    id_usu=models.ForeignKey(usu, on_delete=models.CASCADE, null=False, blank =False)#Responsable de la actividad
...
class tarea(models.Model):
    ...
    id_pry_base = models.ForeignKey(pry_base, on_delete=models.CASCADE, null=False, blank =False)
    id_usu=models.ForeignKey(usu, on_delete=models.CASCADE, null=False, blank =False)#Responsable de la tarea
