...
class etapa(models.Model):
    ...
    fch_ini_eta = models.DateField(null=True, blank=True, auto_now=True)#Fecha de inicio de la etapa
    fch_fin_eta =  models.DateField(null=True, blank=True)#Fecha de finalización de la etapa
...
class fase(models.Model):
    ...
    fch_ini_fase = models.DateField(null=True, blank=True, auto_now=True)#Fecha de inicio de la fase
    fch_fin_fase =  models.DateField(null=True, blank=True)#Fecha de finalización de la fase
...
class proceso(models.Model):
    ...
    fch_ini_pro = models.DateField(null=True, blank=True, auto_now=True)#Fecha de inicio del proceso
    fch_fin_pro =  models.DateField(null=True, blank=True)#Fecha de finalización del proceso
...
class tarea(models.Model):
    ...
    id_recurso = models.ForeignKey(rec_pry, on_delete=models.SET_NULL, null=True, blank =False)#Id del recurso de la tarea
...
class acti(models.Model):
    ...
    id_recurso = models.ForeignKey(rec_pry, on_delete=models.SET_NULL, null=True, blank =False)#Id del recurso de la actividad
    class Meta:
