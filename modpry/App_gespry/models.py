...
class cpto_pry(models.Model):
    ...
    obj_esp = models.ForeignKey(obj_esp, null=False, blank =False) #Objetivos específicos
    ...
    mar_teo = models.ForeignKey(mar_teo, null=False, blank =False)
    mar_con =  models.ForeignKey(mar_con, null=False, blank =False)
    class Meta:
