...
#Clase para la medicion de productos
...
#Clase para la certificacion de productos
...
#Clase para los soportes de certificacion
...
class supp_cert (models.Model):
    ...
    archivo=models.BooleanField('Archivo del registro'  , blank=True,null=False, default=0) #Estado de archivo del registro
    id_cert=models.ForeignKey(prd_cert,null=True,blank=False, on_delete=models.SET_NULL, db_constraint=True)# Identificador de la certificiacion
