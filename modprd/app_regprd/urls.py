...
urlpatterns = [
    ...
    path('listprd/', vst_listprd.as_view(), name='listar_prd'), # url para la interfaz de seleccion de productos
    ...
    path('consreqcal/', vst_list_reqcal.as_view(), name='listar_reqcal'),# urls para la interfaz de consulta de requerimientos de calidad
    ...
    path('conscateg/', vst_list_categ.as_view(), name='listar_categ'),# urls para la interfaz de consultar una categoria
    ...
    path('constipoprd/', vst_list_tipo.as_view(), name='listar_tipo'),# urls para la interfaz de consulta de tipos de producto
    ...
    path('conscampo/', vst_list_camp.as_view(), name='listar_campo'),# urls para la interfaz de listado de campos 
    ...
    path('listplt/', vst_list_plt.as_view(), name='listar_plantilla'),# urls para la interfaz de consulta de plantillas de un producto
